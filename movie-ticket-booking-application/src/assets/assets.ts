...
export interface dummyTrailersType {
  image: string;
  videoUrl: string;
}

export interface dummyCastType {
  name: string;
  profile_path: string;
}
...
export const dummyTrailers: dummyTrailersType[] = [
  {
...
const dummyCastsData: dummyCastType[] = [
  {
    name: "Milla Jovovich",
    profile_path:
...
export const dummyDateTimeData : Record<string,DateTimeType[]> = {
  "2025-07-24": [
...
export interface ActiveShowsType {
    _id : string,
...
export interface DummyDashboardDataType{
    totalBookings : number,
    totalRevenue : number,
    totalUser : number,
    activeShows : ActiveShowsType[]
}
...
export interface ShowsDataType {
    _id : string,
    movie : dummyShowsDataType,
    showDateTime : string,
    showPrice : number,
...
export interface DummyBookingDataType {
    _id : string,
